 ...
 <main>
        ...
        <div class="mdl-grid card-centered">
          ...
          <div class="mdl-cell mdl-cell--3-col mdl-card mdl-shadow--2dp">
            ...
            <div class="mdl-card__actions mdl-card--border">
              <a class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect middle" href="/GenerarTicket" title="Próximamente">
              Generar ticket
              </a>
              <span class="split">
              </span>
              <a class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect middle" href="/GenerarPreTicket" title="Próximamente">
              Generar pre-ticket
              </a>
              <span class="split">
              </span>
          ...
          <div class="mdl-cell mdl-cell--3-col mdl-card mdl-shadow--2dp">
            ...
            <div class="mdl-card__actions mdl-card--border">
              <a class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect middle" href="" title="Próximamente">
              otros
              </a>
              <span class="split">
              </span>
