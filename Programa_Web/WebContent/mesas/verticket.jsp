...
<BODY>
	...
	<div class="mdl-grid center-items">
		<div class="mdl-cell mdl-cell--4-col">
			<h2 class="mdl-card__title-text">VISUALIZAR TICKET</h2>

			<form action="/Programa_Web/verticket" method="post">

				<div class="mdl-textfield mdl-js-textfield">
					<input class="mdl-textfield__input" type="text"
						pattern="-?[0-9]*(\.[0-9]+)?" id="sample2" name="idticket">
					<label class="mdl-textfield__label" for="sample2">ID
						Ticket...</label> <span class="mdl-textfield__error">Lo ingresado
